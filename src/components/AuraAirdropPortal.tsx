    ...
    const interval = setInterval(() => {
      ...
      if (progress >= 100) {
        ...
        const updatedUser = {
          ...
          karmaScore: calculatedKarmaScore > 850 ? 850 : calculatedKarmaScore,
          lastClaimedAt: today
        };
